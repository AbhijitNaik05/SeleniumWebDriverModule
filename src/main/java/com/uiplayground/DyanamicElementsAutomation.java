...
public class DyanamicElementsAutomation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement toggleVisiblityButton = wd.findElement(toggleVisiblityButtonLocator);
		toggleVisiblityButton.click();
	    By visiblityTextLoactor = By.xpath("//span[@data-testid='visibility-state']");
	    WebElement visiblityText = wd.findElement(visiblityTextLoactor);
